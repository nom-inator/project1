...
--
-- Name: address; Type: TABLE; Schema: public; Owner: cw2952
--
...
ALTER TABLE address OWNER TO cw2952;

--
-- Name: condition; Type: TABLE; Schema: public; Owner: cw2952
--
...
ALTER TABLE condition OWNER TO cw2952;

--
-- Name: favouriteslist; Type: TABLE; Schema: public; Owner: cw2952
--
...
ALTER TABLE favouriteslist OWNER TO cw2952;

--
-- Name: restaurant; Type: TABLE; Schema: public; Owner: cw2952
--
...
ALTER TABLE restaurant OWNER TO cw2952;

--
-- Name: restaurantoflist; Type: TABLE; Schema: public; Owner: cw2952
--
...
ALTER TABLE restaurantoflist OWNER TO cw2952;

--
-- Name: test; Type: TABLE; Schema: public; Owner: cw2952
--
...
ALTER TABLE test OWNER TO cw2952;

--
-- Name: test_id_seq; Type: SEQUENCE; Schema: public; Owner: cw2952
--
...
ALTER TABLE test_id_seq OWNER TO cw2952;

--
-- Name: test_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: cw2952
--
...
--
-- Name: user_location; Type: TABLE; Schema: public; Owner: cw2952
--
...
ALTER TABLE user_location OWNER TO cw2952;

--
-- Name: users; Type: TABLE; Schema: public; Owner: cw2952
--
...
CREATE TABLE users (
    ...
    name text,
    lid text,
    passwd character varying(50) DEFAULT 'pass'::character varying NOT NULL
);


ALTER TABLE users OWNER TO cw2952;

--
-- Name: visit; Type: TABLE; Schema: public; Owner: cw2952
--
...
ALTER TABLE visit OWNER TO cw2952;

--
-- Name: id; Type: DEFAULT; Schema: public; Owner: cw2952
--
...
--
-- Data for Name: test; Type: TABLE DATA; Schema: public; Owner: cw2952
--
...
--
-- Name: test_id_seq; Type: SEQUENCE SET; Schema: public; Owner: cw2952
--
...
l7	evanj	40.7646513	-73.9805406
l11	hello_world	40.764658499999996	-73.9805073
\.
...
COPY users (uid, name, lid, passwd) FROM stdin;
bob999	Bob	l1	pass
angel88	Angel	l2	pass
mike	Mike	l3	pass
stvn	Steven	l4	pass
mary0704	Mary	l5	pass
ewu	Eugene	l6	pass
evanj	Evan	l7	pass
pmann	Peyton Manning	l8	pass
tombrady	Tom Brady	l9	pass
queenbeeftw	Beyonc̩	l10	pass
hello_world	Hello World!	l11	pass
\.
...
--
-- Name: address_pkey; Type: CONSTRAINT; Schema: public; Owner: cw2952
--
...
--
-- Name: condition_pkey; Type: CONSTRAINT; Schema: public; Owner: cw2952
--
...
--
-- Name: favouriteslist_pkey; Type: CONSTRAINT; Schema: public; Owner: cw2952
--
...
--
-- Name: restaurant_pkey; Type: CONSTRAINT; Schema: public; Owner: cw2952
--
...
--
-- Name: restaurantoflist_pkey; Type: CONSTRAINT; Schema: public; Owner: cw2952
--
...
--
-- Name: user_location_pkey; Type: CONSTRAINT; Schema: public; Owner: cw2952
--
...
--
-- Name: users_pkey; Type: CONSTRAINT; Schema: public; Owner: cw2952
--
...
--
-- Name: visit_pkey; Type: CONSTRAINT; Schema: public; Owner: cw2952
--
...
ALTER TABLE ONLY user_location
    ADD CONSTRAINT user_location_uid_fkey FOREIGN KEY (uid) REFERENCES users(uid);
